...
export const LoginForm: React.FC<LoginFormProps> = ({
  ...
  // Router for redirecting after successful login
  ...
  const handleSocialLogin = async (provider: 'google' | 'facebook') => {
    ...
    try {
      ...
      // In a real implementation, this would call the appropriate social auth provider
      // For demonstration, we'll simulate a successful login after a delay
      await new Promise(resolve => setTimeout(resolve, 1000));
  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-6 text-center text-sm text-gray-600">
        ...
        <Link href="/auth/register" className="ml-1 font-medium text-primary hover:text-primary-dark">
          Sign up now
        </Link>
      </div>
    </div>
